...
body{
    ...
    background: -webkit-linear-gradient(left,rgba(255,255,255,1), rgba(0,255,127,1) );
...
ul.topnav {
   ...
   background: -webkit-linear-gradient(right,rgba(255,255,255,1),rgba(0,255,127,1));
	padding-right: 1.2cm;
	//padding-left: 0cm;
}
...
<div class="wrapper" align="center">
	...
	<div  class="image" align="center" >
		...
		<div class="w3-quarter" align="left"style="width:200px;height:250px;">
			...
			<li style="float:left";><a href="iPhone7.php">Review</a></li>
