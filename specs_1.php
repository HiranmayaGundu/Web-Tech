...
body{
    ...
    background: -webkit-linear-gradient(right,#BDA0CB,  rgba(221,160,221,0.9)  );
...
ul.topnav li.icon {display: none;}
	...
	div.image
	{
		...
		background: -webkit-linear-gradient(left,rgba(255,255,255,1), rgba(216,191,216, 1));
